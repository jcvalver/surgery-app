          ...
          <div class="lg:col-span-1">
            ...
            <div class="flex items-center gap-3">
              ...
              ${siteData.socialMedia.youtube ? `
                <a href="${siteData.socialMedia.youtube}" target="_blank" rel="noopener noreferrer"
                   aria-label="YouTube" class="w-9 h-9 rounded-full bg-neutral-800 hover:bg-[#FF0000] flex items-center justify-center transition-colors">
